...
%Declaração de Vetores de números para utilizar como auxílio na função mode como voto majoritário 
predMdl1cvmodelnum = 1:2100;
predMdl2cvmodelnum = 1:2100;
predMdl3cvmodelnum = 1:2100;
predMdl4cvmodelnum = 1:2100;

%Inserindo os números nos 4 vetores que correspondem às classes
for n = 1:2100
...
%Matriz de 4 colunas com as previsões dos 4 modelos agora em números 
...
%Loop para converter o array de classes de referência em um vetor de números
for n = 1:2100
